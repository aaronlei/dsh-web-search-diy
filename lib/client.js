	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			modeAnthropic: "DeepSeek 官方（Anthropic 兼容 Messages API + web_search）",
		...
		const en = {
			...
			modeAnthropic: "DeepSeek official (Anthropic-compatible Messages API + web_search)",
		...
		*/
		...
		const DRAFT_KEYS = ["mode", "baseURL", "apiKeyEnv", "model", "maxOutputTokens", "apiVersion", "maxUses", "searchEngine", "count", "searchRecencyFilter", "contentSize", "reasoningEffort", "responsesReasoningEffort", "searchDomainFilter", "searchIntent", "searchPrompt"];
		/**
