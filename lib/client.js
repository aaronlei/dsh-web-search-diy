window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const DRAFT_KEYS = ["mode", "baseURL", "apiKeyEnv", "model", "maxOutputTokens", "searchEngine", "count", "searchRecencyFilter", "contentSize", "reasoningEffort", "searchDomainFilter", "searchIntent", "searchPrompt"];
		/**
